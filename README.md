...
<h1 align="center">graphite_exporter (container image)</h1>
<p align="center">Built-from-source container image of <a href="https://prometheus.io/">Prometheus</a>' <a href="https://github.com/prometheus/graphite_exporter">Graphite exporter</a></p>
...
```bash
docker build --tag ricardbejarano/graphite_exporter --file Dockerfile .
```
